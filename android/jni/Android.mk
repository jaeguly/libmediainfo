...
USER_CFLAGS		+= -DMEDIAINFO_LIBCURL_DLL_RUNTIME
#USER_CFLAGS		+= -DMEDIAINFO_DUPLICATE_NO
...
# -Ijni/../../MediaInfoLib/Source
# -Ijni/../../ZenLib/Source
# -IC:/Apps/android/android-ndk-r5b/sources/cxx-stl/system/include
# -IC:/Apps/android/android-ndk-r5b/sources/cxx-stl/stlport/stlport
# -Ijni
# -DANDROID -fshort-wchar -DUNICODE
# -DMEDIAINFO_LIBCURL_NO -DMEDIAINFO_LIBMMS_NO -DMEDIAINFO_TRACE_YES
# -Wa,--noexecstack -O0 -g
# -IC:/Apps/android/android-ndk-r5b/platforms/android-5/arch-arm/usr/include
# -c xxx.cpp -o xxx.o
#
# in release:
#	-O0 => -O2
#		=> -DNDEBUG
#
# g++ -Wl,-soname,libmediainfo-jni.so -shared
# --sysroot=C:/Apps/android/android-ndk-r5b/platforms/android-5/arch-arm
# D:/home/ws/mediainfo_trunk/Android/obj/local/armeabi/objs-debug/mediainfo-jni/libmediainfo-jni.o
# D:/home/ws/mediainfo_trunk/Android/obj/local/armeabi/libstdc++.a
# D:/home/ws/mediainfo_trunk/Android/obj/local/armeabi/libstlport_static.a
# D:/home/ws/mediainfo_trunk/Android/obj/local/armeabi/libmediainfo.so
# C:/Apps/android/android-ndk-r5b/platforms/android-5/arch-arm/usr/lib/libc.so
# C:/Apps/android/android-ndk-r5b/platforms/android-5/arch-arm/usr/lib/libstdc++.so
# C:/Apps/android/android-ndk-r5b/platforms/android-5/arch-arm/usr/lib/libm.so
# -Wl,--no-undefined -Wl,-z,noexecstack
# -LC:/Apps/android/android-ndk-r5b/platforms/android-5/arch-arm/usr/lib
# -lz -llog -lstdc++
# -Wl,-rpath-link=C:/Apps/android/android-ndk-r5b/platforms/android-5/arch-arm/usr/lib
# -lsupc++
# -o D:/home/ws/mediainfo_trunk/Android/obj/local/armeabi/libmediainfo-jni.so
#
